...
export default function UserPost( {
  ...
  return (
    ...
    {
        data ? (<Show type={data.type} postType={data.postType} id={data._id} src={data.post} name={data.user.name} text={data.description} userImage={data.user.profileUrl} likes={data.likes} comments={data.comments} created={data.createdAt} />): (<Loader />)
        }
    <div className="mt-6">
